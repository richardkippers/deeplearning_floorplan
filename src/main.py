...
from models.UNet import UNetModelBuilder
from models.misc_functions import iou
...
# Globals
LOW_GPU_MEMORY = True if socket.gethostname() == "richard-ThinkPad-P50" else False 
